...
func GetIssueTotalTrackedTime(opts *IssueStatsOptions, isClosed bool) (int64, error) {
...
func getIssueTotalTrackedTimeChunk(opts *IssueStatsOptions, isClosed bool, issueIDs []int64) (int64, error) {
	sumSession := func(opts *IssueStatsOptions, issueIDs []int64) *xorm.Session {
